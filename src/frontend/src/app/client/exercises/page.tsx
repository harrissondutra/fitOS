...
import { Search, Filter, Dumbbell, Target, Clock, Users, BookOpen } from 'lucide-react';
...
export default function MemberExercisesPage() {
  ...
  const beginnerExercises = exercises?.filter(exercise => exercise.difficulty === 'beginner') || [];
      ...
      <div className="space-y-6">
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-muted-foreground">Browse exercises and learn proper techniques</p>
          </div>
        </div>
    ...
    <div className="space-y-6">
      ...
      <div className="grid gap-4 md:grid-cols-4">
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">{beginnerExercises.length}</div>
            <p className="text-xs text-muted-foreground">
              Easy to start with
            </p>
          </CardContent>
      ...
      <Tabs defaultValue="all" className="space-y-4">
        <TabsList>
          ...
          <TabsTrigger value="beginner">Beginner ({beginnerExercises.length})</TabsTrigger>
            ...
            <Card>
              <CardContent className="p-6">
                <div className="text-center">
                  ...
                  <h3 className="text-lg font-semibold mb-2">No beginner exercises</h3>
                  <p className="text-muted-foreground">No beginner exercises found with current filters.</p>
                </div>
              </CardContent>
            </Card>
          )}
