...
import { Search, Filter, Plus, Dumbbell, Calendar, CheckCircle, Clock, Target } from 'lucide-react';
...
export default function TrainerWorkoutsPage() {
  ...
  const user = { role: 'TRAINER' as const };
      ...
      <div className="space-y-6">
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-muted-foreground">Gerencie treinos para seus membros</p>
          </div>
        </div>
                ...
                <div className="text-center">
                  ...
                  <p className="text-muted-foreground mb-4">
                    {filters.search || filters.completed !== undefined
                      ...
                      : 'You haven\'t created any treinos yet.'}
                  </p>
                  <Button>
                    <Plus className="h-4 w-4 mr-2" />
            ...
            <Card>
              <CardContent className="p-6">
                <div className="text-center">
                  ...
                  <p className="text-muted-foreground">No treinos have been completed yet.</p>
                </div>
              </CardContent>
            </Card>
          )}
            ...
            <Card>
              <CardContent className="p-6">
                <div className="text-center">
                  ...
                  <p className="text-muted-foreground">All treinos have been completed!</p>
                </div>
              </CardContent>
            </Card>
          )}
            ...
            <Card>
              <CardContent className="p-6">
                <div className="text-center">
                  ...
                  <p className="text-muted-foreground">No treinos were created this week.</p>
                </div>
              </CardContent>
            </Card>
          )}
